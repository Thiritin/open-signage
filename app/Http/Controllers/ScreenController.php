    ...
    public function __invoke(Request $request, $slug = null)
    {
        ...
        return Inertia::render('Main', [
            ...
            'initialArtworks' => Artwork::all()->map(fn(Artwork $artwork) => [
                ...
                'horizontal' => ($artwork->file_horizontal === null) ? null : Storage::disk('public')->url($artwork->file_horizontal),
                'vertical' => ($artwork->file_vertical === null) ? null : Storage::disk('public')->url($artwork->file_vertical),
                'banner' => ($artwork->file_banner === null) ? null : Storage::disk('public')->url($artwork->file_banner),
            ])->toArray(),
