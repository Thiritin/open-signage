...
import HourGlassSVG from "@/Projects/EF28/Assets/images/Hourglass4.svg";
...
onMounted(() => {
    ...
    let timer = setInterval(() => {
        ...
        if(time.minutes[1] !== newTime.minutes[1]){
            let opacity00 = window.getComputedStyle(m00.value).getPropertyValue("opacity");
            if(opacity00 == 0){
            ...
            let opacity01 = window.getComputedStyle(m01.value).getPropertyValue("opacity");
            if(opacity01 == 0){
        ...
        if(time.minutes[0] !== newTime.minutes[0]){
            let opacity10 = window.getComputedStyle(m10.value).getPropertyValue("opacity");
            if(opacity10 == 0){
            ...
            let opacity11 = window.getComputedStyle(m11.value).getPropertyValue("opacity");
            if(opacity11 == 0){
        ...
        if(time.hours[1] !== newTime.hours[1]){
            let opacity00 = window.getComputedStyle(h00.value).getPropertyValue("opacity");
            if(opacity00 == 0){
            ...
            let opacity01 = window.getComputedStyle(h01.value).getPropertyValue("opacity");
            if(opacity01 == 0){
        ...
        if(time.hours[0] !== newTime.hours[0]){
            let opacity10 = window.getComputedStyle(h10.value).getPropertyValue("opacity");
            if(opacity10 == 0){
            ...
            let opacity11 = window.getComputedStyle(h11.value).getPropertyValue("opacity");
            if(opacity11 == 0){
...
<template>
    ...
    <div class="absolute z-10 top-4 right-5 text-7xl flex flex-row items-end magicTextColor themeFont">
